...
if $build_libmosaic_codec; then
    ...
    clang -fPIC -shared -Wall -Werror -O3 $stb_options -o $lib_dir/libmosaic-codec$dynamic_lib_extension libmosaic-codec/codec.c
fi
...
if $build_libmosaic_fft; then
    ...
    clang++ -fPIC -shared -Wall -Werror -O3 -std=c++17 -o $lib_dir/libmosaic-fft$dynamic_lib_extension libmosaic-fft/fft.cpp
fi
